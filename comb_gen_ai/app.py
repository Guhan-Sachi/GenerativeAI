...
headers = {"Authorization": "Bearer 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"}
...
def chat():
    ...
    if response_type == 'image':
        ...
        if detected_language != 'ta':  # 'ta' is the language code for Tamil
            return jsonify({"response": "Please enter your message in Tamil."})
